...
private:
    ...
    mtc::Task createTask();
    geometry_msgs::msg::Vector3Stamped computeApproachVector();
    mtc::Task task_;
...
geometry_msgs::msg::Vector3Stamped MTCTaskNode::computeApproachVector() {
...
mtc::Task MTCTaskNode::createTask() {
     ...
     ****************************************************/
    {
         ...
         ****************************************************/
        {
            ...
            // Compute approach direction dynamically from link_1 to object
